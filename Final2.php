...
-->
  ...
  <body onload="openCity(event, 'Paris'), attempt(2)">
  <h1>Image Manager</h1>
    <div class="tab">
      <a href="Final.php"><button class="tablinks">Photos</button></a>
      <button class="tablinks">Add Photo</button>
      <a href="Final3.php"><button class="tablinks" onclick="delPhoto()">Delete Photo</button></a>
